...
/////////////////////////////////////////////
    ...
    protected function DrawDataValueLabel($x_or_y, $row, $column, $x_world, $y_world, $text, $dvl)
    {
        ...
        // **** Cambios para mostrar el label encima y debajo dependiendo de la
        // serie - FMVQ 11/11/2021 ****

        //extract($dvl);

        $v_align = $column % 2 == 0 ? 'top' : 'bottom';
        $y_offset = $column % 2 == 0 ? 6 : -6;
        // **** Cambios para mostrar el label encima y debajo dependiendo de la
        // serie - FMVQ 11/11/2021 ****
...
/////////////////////////////////////////////
    ...
    protected function GetDataColor($row, $idx, &$vars, &$data_color, $extra = 0)
    {
        ...
        //****************************************************************
        // **** Cambio para pintar el datalabel del color de la serie ****
        //****************************************************************
        $this->ndx_dvlabel_color = $this->ndx_data_colors[$idx];
    }
